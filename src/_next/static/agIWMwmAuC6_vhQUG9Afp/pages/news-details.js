  ...
  [20],
  {
    "2lF0": function (e, a, s) {
                ...
                o(
                  ...
                  o(
                    ...
                    o(
                      ...
                      o("img", {
                        src: "/assets/images/blog-d-1-1.jpg",
                        alt: "",
                      })
                    ),
                    o(
                      "div",
                      { className: "blog-one__content text-center" },
                      o(
                        "div",
                        ...
                        o(
                          ...
                          o("i", { className: "fa fa-calendar-alt" })
                        ),
                        o(
                          "a",
                          {
                  ...
                  o(
                    ...
                    o(
                      ...
                      o(
                        "a",
                        { href: "#" },
                        o("i", { className: "fab fa-twitter" })
                      ),
                      o(
                        "a",
                        { href: "#" },
                        o("i", { className: "fab fa-facebook-f" })
                      ),
                      o(
                        "a",
                        { href: "#" },
                        o("i", { className: "fab fa-instagram" })
                      ),
                      o(
                        "a",
                        { href: "#" },
                        o("i", { className: "fab fa-dribbble" })
                      )
                    )
                  ),
                  o(
                    "div",
                    { className: "blog-details__author" },
                    o(
                      "div",
                      { className: "blog-details__author-image" },
                      o("img", {
                        src: "/assets/images/author-1-1.jpg",
                        alt: "Awesome Image",
                      })
                    ),
                    o(
                      "div",
                      { className: "blog-details__author-content" },
                      o("h3", null, "Christine Eve"),
                      o(
                        "p",
                        null,
                  ...
                  o(
                    "h2",
                    { className: "blog-details__content-title" },
                    "2 Comments"
                  ),
                  o(
                    "div",
                    ...
                    o(
                      ...
                      o(
                        ...
                        o(
                          "div",
                          { className: "comment-one__content-top" },
                          o(
                            "div",
                            { className: "comment-one__top-left" },
                            o(
                              "h3",
                              { className: "comment-one__author" },
                              "Laquanda Bachmeier"
                            ),
                            o(
                              "p",
                            ...
                            o(
                              "p",
                              { className: "comment-one__text" },
                              "Lorem Ipsum is simply dummy text of the rinting and typesetting been the industry standard dummy text ever sincer condimentum purus. In non ex at ligula fringilla lobortis et not the aliquet."
                            )
                          ),
                          o(
                            "div",
                            { className: "comment-one__top-right" },
                            o(
                              "a",
                              {
                                href: "#",
                ...
                o(
                  ...
                  o(
                    ...
                    o(
                      ...
                      o(
                        "form",
                        { action: "#", className: "sidebar__search-form" },
                        o("input", {
                          type: "text",
                          name: "search",
                    ...
                    o(
                      ...
                      o("h3", { className: "sidebar__title" }, "Latest Posts"),
                      o(
                        "div",
                    ...
                    o(
                      ...
                      o("h3", { className: "sidebar__title" }, "Categories"),
                      o(
                        "ul",
                        ...
                        o(
                          "li",
                          { className: "sidebar__category-list-item" },
                          o("a", { href: "#" }, "Introductions")
                        ),
                        o(
                          "li",
                          { className: "sidebar__category-list-item" },
                          o("a", { href: "#" }, "One Page Template")
                        ),
                        o(
                          "li",
                          { className: "sidebar__category-list-item" },
                          o("a", { href: "#" }, "Parallax Effects")
                        ),
                        o(
                          "li",
                          { className: "sidebar__category-list-item" },
                          o("a", { href: "#" }, "New Technologies")
                        ),
                        o(
                          "li",
                          { className: "sidebar__category-list-item" },
                          o("a", { href: "#" }, "Video Backgrounds")
                        )
                      )
                    ),
                    o(
                      ...
                      o("h3", { className: "sidebar__title" }, "Tags"),
                      o(
                        "ul",
                        { className: "sidebar__tags-list" },
                        o(
                          "li",
                          { className: "sidebar__tags-list-item" },
                          o("a", { href: "#" }, "Business,")
                        ),
                        o(
                          "li",
      ...
      a.default = function () {
        return d(
          i.a,
          { pageTitle: "Kipso | News Details" },
          d(n.a, null),
          d(r.a, { title: "News Details" }),
          d(m, null),
          d(c.a, null)
        );
      };
        ...
        return r(
          ...
          r(
            ...
            r(
              ...
              r("li", null, r(n.a, { href: "/" }, r("a", null, "Home"))),
              r("li", { className: "active" }, r("a", { href: "#" }, e.title))
            ),
            r("h2", { className: "inner-banner__title" }, e.title)
          )
        );
      };
    },
      ...
      var f = (function (e) {
          ...
          s =
            ...
            function () {
              var e,
                s = Object(r.a)(a);
              if (g()) {
                var t = Object(r.a)(this).constructor;
        ...
        function m() {
          ...
          return (
            Object(t.a)(this, m),
            (e = s.call(this)),
            Object(o.a)(Object(i.a)(e), "handleScroll", function () {
              window.scrollY > 70
                ? e.setState({ sticky: !0 })
                : window.scrollY < 70 && e.setState({ sticky: !1 });
            }),
            Object(o.a)(Object(i.a)(e), "mobileMenu", function () {
            ...
            Object(o.a)(Object(i.a)(e), "serachButton", function () {
                    ...
                    h(
                      ...
                      h(
                        ...
                        h(
                          ...
                          h(
                            "a",
                            { href: "#" },
                            h("i", { className: "fab fa-twitter" })
                          ),
                          h(
                            "a",
                            { href: "#" },
                            h("i", { className: "fab fa-facebook-square" })
                          ),
                          h(
                            "a",
                            { href: "#" },
                            h("i", { className: "fab fa-pinterest-p" })
                          ),
                          h(
                            "a",
                            { href: "#" },
                        ...
                        h(
                          ...
                          h("span", { className: "kipso-icon-menu" })
                        )
                      ),
                      h(
                        "div",
                            ...
                            h(
                              ...
                              h(
                                ...
                                h(
                                  _.a,
                                  { href: "/pricing" },
                                  h("a", null, "Pricing Plans")
                                )
                              ),
                              h(
                                "li",
                                null,
                                h(_.a, { href: "/faq" }, h("a", null, "FAQ'S"))
                              )
                            )
                          ),
                          h(
                      ...
                      h(
                        ...
                        h(
                          ...
                          h("i", { className: "kipso-icon-magnifying-glass" })
                        )
                      )
                    )
                  ),
                  h(
                    ...
                    h(
                      ...
                      h(
                        ...
                        h("div", { className: "site-header__decor-inner-1" })
                      ),
                      h(
                        "div",
                        { className: "site-header__decor-single" },
                        h("div", { className: "site-header__decor-inner-2" })
                      ),
                      h(
                        "div",
                        { className: "site-header__decor-single" },
                        h("div", { className: "site-header__decor-inner-3" })
                      )
                    )
                  )
                );
