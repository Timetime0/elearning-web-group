            ...
            <div className="row">
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="team-one__single">
                  ...
                  <div className="team-one__content">
                    <h2 className="team-one__name">
                      <a href="team-details.html">Phoebe Park</a>
                    </h2>
                    <p className="team-one__designation">Teacher</p>
                    <p className="team-one__text">
                      There are many varia of passages of lorem.
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="team-one__single">
                  ...
                  <div className="team-one__content">
                    <h2 className="team-one__name">
                      <a href="team-details.html">Matilda Hawkins</a>
                    </h2>
                    <p className="team-one__designation">Teacher</p>
                    <p className="team-one__text">
                      There are many varia of passages of lorem.
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="team-one__single">
                  ...
                  <div className="team-one__content">
                    <h2 className="team-one__name">
                      <a href="team-details.html">Lizzie Butler</a>
                    </h2>
                    <p className="team-one__designation">Teacher</p>
                    <p className="team-one__text">
                      There are many varia of passages of lorem.
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="team-one__single">
                  ...
                  <div className="team-one__content">
                    <h2 className="team-one__name">
                      <a href="team-details.html">Trevor Turner</a>
                    </h2>
                    <p className="team-one__designation">Teacher</p>
                    <p className="team-one__text">
                      There are many varia of passages of lorem.
